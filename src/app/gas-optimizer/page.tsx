    ...
    <main className="min-h-screen bg-[#0a0a0f] text-white">
      <nav className="flex justify-between items-center px-6 py-4 max-w-7xl mx-auto border-b border-white/[0.05]">
        ...
        <div className="flex gap-4">
          <Link href="/gas" className="text-sm text-white/50 hover:text-white">Gas Tracker</Link>
          <Link href="/gas-optimizer" className="text-sm text-green-400 font-medium">Gas Optimizer</Link>
          <Link href="/dashboard" className="text-sm text-white/50 hover:text-white">Dashboard</Link>
        </div>
      </nav>

      <div className="max-w-6xl mx-auto px-6 py-12">
        <h1 className="text-3xl font-bold mb-2">⛽ Gas Fee Optimizer</h1>
        <p className="text-white/40 mb-8">Predict the best time to transact, set gas alerts, and auto-execute when gas is low</p>
