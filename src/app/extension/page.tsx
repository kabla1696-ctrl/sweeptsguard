...
const FEATURES = [
  ...
  },
  {
    ...
    description: 'Check eligibility for active airdrops across 33+ chains',
    details: ['10+ active airdrops tracked', 'Eligibility checker', 'Direct claim links'],
    status: 'new',
  },
  {
    icon: '🌐',
    ...
    <main className="min-h-screen bg-[#030305] text-white">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-12">
            ...
            {[
              {
                ...
                desc: 'One-click install from Chrome Web Store or download CRX file.',
                icon: '📦',
              },
              {
                step: '2',
        ...
        <div className="mb-10 p-6 bg-gradient-to-br from-yellow-500/[0.06] to-orange-500/[0.06] border border-yellow-500/15 rounded-2xl">
          <h2 className="text-xl font-bold mb-4">📦 Manual Installation (CRX)</h2>
          <div className="space-y-3 text-sm">
            {[
              { step: '1', text: 'Click "Download CRX" above to get the ZIP file' },
              ...
              { step: '6', text: 'SweepGuard icon appears in toolbar — done! 🎉' },
            ].map((item) => (
        ...
        <div className="mb-10 p-6 bg-gradient-to-br from-purple-500/[0.06] to-blue-500/[0.06] border border-purple-500/15 rounded-2xl">
          ...
          <div className="grid md:grid-cols-2 gap-4 text-sm">
            <div className="space-y-3">
              {[
                { title: 'Manifest V3', desc: 'Latest extension standard — secure, fast, audited' },
                { title: 'Local Processing', desc: 'All analysis happens on your device — nothing sent to servers' },
                { title: 'EIP-7702 Support', desc: 'Industry-standard rescue protocol for compromised wallets' },
              ].map((item, i) => (
            ...
            <div className="space-y-3">
              {[
                { title: 'Open Source', desc: 'Fully auditable code on GitHub' },
                { title: 'Auto-Updates', desc: 'Drainer database updated every hour' },
                { title: 'Zero Telemetry', desc: 'No tracking, no analytics, no data collection' },
              ].map((item, i) => (
                <div key={i} className="flex items-start gap-3">
                  <span className="text-green-400 mt-0.5">✅</span>
                  <div>
