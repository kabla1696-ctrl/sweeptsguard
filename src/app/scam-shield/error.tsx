  ...
  useEffect(() => {
    fetch('/api/sentry', {
      ...
      body: JSON.stringify({
        ...
        level: 'error',
        context: { page: 'scam-shield', digest: error.digest },
      }),
    }).catch(() => {})
  }, [error])
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0f] text-white flex items-center justify-center">
      <div className="max-w-md mx-auto text-center px-6">
        ...
        <h1 className="text-2xl font-bold mb-3 text-red-400">Scam Shield Error</h1>
        <p className="text-white/40 text-sm mb-8">
          The transaction analysis engine encountered an error. This has been logged.
        </p>
