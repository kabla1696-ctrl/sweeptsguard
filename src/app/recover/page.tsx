  ...
  return (
    <main className="min-h-screen bg-[#030305] text-white">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/3 w-[500px] h-[500px] bg-purple-500/[0.04] rounded-full blur-[120px]" />
        <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-green-500/[0.03] rounded-full blur-[100px]" />
      </div>
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-6 py-12">
        <h1 className="text-4xl md:text-5xl font-black mb-2">
          💰 Fund <span className="bg-gradient-to-r from-purple-400 to-green-400 bg-clip-text text-transparent">Recovery</span>
        </h1>
        <p className="text-gray-500 text-lg mb-4">Multi-chain asset recovery + one-click delegation revoke</p>
